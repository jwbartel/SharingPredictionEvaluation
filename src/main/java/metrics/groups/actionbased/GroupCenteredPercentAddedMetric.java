...
public class GroupCenteredPercentAddedMetric<CollaboratorType, ActionType extends CollaborativeAction<CollaboratorType>>
	...
	public String getHeader() {
		return "avg-group-centered percent added,stdev-group-centered percent added";
	}
