...
public class TotalRecommendedGroupsMetric<CollaboratorType, ActionType extends CollaborativeAction<CollaboratorType>>
	...
	public MetricResult evaluate(
		...
		return new DoubleResult(recommendations.size());
	}

	@Override
	public String getHeader() {
		return "total recommended groups";
	}
